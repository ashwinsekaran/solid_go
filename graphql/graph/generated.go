...
type ComplexityRoot struct {
	...
	Mutation struct {
		CreateInvoice func(childComplexity int, customer string, amount float64, status string) int
	}
...
type MutationResolver interface {
	CreateInvoice(ctx context.Context, customer string, amount float64, status string) (*model.Invoice, error)
}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Invoice.customer":
		if e.ComplexityRoot.Invoice.Customer == nil {
			break
		}

		return e.ComplexityRoot.Invoice.Customer(childComplexity), true
	case "Invoice.id":
	...
	case "Mutation.createInvoice":
		...
		return e.ComplexityRoot.Mutation.CreateInvoice(childComplexity, args["customer"].(string), args["amount"].(float64), args["status"].(string)), true
	...
	case "Query.invoices":
		...
		return e.ComplexityRoot.Query.Invoices(childComplexity), true
...
func (ec *executionContext) field_Mutation_createInvoice_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "customer",
...
func (ec *executionContext) _Mutation_createInvoice(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Mutation_createInvoice(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Mutation().CreateInvoice(ctx, fc.Args["customer"].(string), fc.Args["amount"].(float64), fc.Args["status"].(string))
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *model.Invoice) graphql.Marshaler {
			return ec.marshalNInvoice2ᚖsolid_goᚋgraphqlᚋgraphᚋmodelᚐInvoice(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Query_invoices(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			return ec.Resolvers.Query().Invoices(ctx)
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v []*model.Invoice) graphql.Marshaler {
			return ec.marshalNInvoice2ᚕᚖsolid_goᚋgraphqlᚋgraphᚋmodelᚐInvoiceᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Query_invoice(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *model.Invoice) graphql.Marshaler {
			return ec.marshalOInvoice2ᚖsolid_goᚋgraphqlᚋgraphᚋmodelᚐInvoice(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) marshalNInvoice2solid_goᚋgraphqlᚋgraphᚋmodelᚐInvoice(ctx context.Context, sel ast.SelectionSet, v model.Invoice) graphql.Marshaler {
	return ec._Invoice(ctx, sel, &v)
}

func (ec *executionContext) marshalNInvoice2ᚕᚖsolid_goᚋgraphqlᚋgraphᚋmodelᚐInvoiceᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Invoice) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNInvoice2ᚖsolid_goᚋgraphqlᚋgraphᚋmodelᚐInvoice(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNInvoice2ᚖsolid_goᚋgraphqlᚋgraphᚋmodelᚐInvoice(ctx context.Context, sel ast.SelectionSet, v *model.Invoice) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOInvoice2ᚖsolid_goᚋgraphqlᚋgraphᚋmodelᚐInvoice(ctx context.Context, sel ast.SelectionSet, v *model.Invoice) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Invoice(ctx, sel, v)
