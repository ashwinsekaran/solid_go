...
//
// Pseudo code:
//   BFS from beginWord to endWord, track shortest distances for each word
//   Build parent map: for each word, store which words can precede it on shortest path
//   DFS from endWord back to beginWord using parent map to reconstruct all paths
